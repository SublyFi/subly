...
| Tuk Tuk       | 1b281ae+   | Helium のオンチェーン自動化エンジン。定期支払いの自己再キューイングを実現                      |
...
| Tuk Tuk              | 定期支払い処理の自動実行・自己再キューイング               |
...
| 日次支払い 100+ | Tuk Tuk による自己再キューイング     |
...
4. 自動支払いフロー
   └── Tuk Tuk crank → process_payment_with_requeue → 帳簿更新 → 次回タスク自己再キュー
...
| arcis          | =0.6.3       | 完全固定                          |
| tuktuk-program | git (1b281ae)| Git リビジョンで固定              |
...
| ---------- | ---------- | -------- | ------ |
| 2025-01-31 | 1.0        | 初版作成 | -      |
| 2026-02-01 | 1.1        | Tuk Tuk 統合を追加（Clockwork から移行） | -      |
