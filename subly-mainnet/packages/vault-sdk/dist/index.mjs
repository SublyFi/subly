...
function getShieldPoolPda(programId = PROGRAM_ID) {
  return PublicKey2.findProgramAddressSync([SHIELD_POOL_SEED], programId);
}
...
var USDC_MINT = new PublicKey3("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var PRIVACY_CASH_PROGRAM_ID = new PublicKey3("9fhQBbumKEFuXtMBDw8AaQyAjCorLGJQiS3skWZdQyQD");
...
var KAMINO_LENDING_PROGRAM_ID = new PublicKey4("KLend2g3cP87ber41VSz2cHu5M3mxzQS7pzLFz1UJwp");
var USDC_MINT2 = new PublicKey4("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var KAMINO_MAIN_MARKET = new PublicKey4("7u3HeHxYDLhnCoErrtycNokbQYbWGzLs6JSDqGAv5PfF");
