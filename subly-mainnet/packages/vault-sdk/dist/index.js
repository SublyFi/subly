...
var import_web35, import_anchor, TUKTUK_PROGRAM_ID, TUKTUK_CRON_PROGRAM_ID, TukTukIntegration, TukTukError;
var init_tuktuk = __esm({
  "src/integrations/tuktuk.ts"() {
    "use strict";
    import_web35 = require("@solana/web3.js");
    import_anchor = require("@coral-xyz/anchor");
    TUKTUK_PROGRAM_ID = new import_web35.PublicKey("tuktukUrfhXT6ZT77QTU8RQtvgL967uRuVagWF57zVA");
    TUKTUK_CRON_PROGRAM_ID = new import_web35.PublicKey("cronAjRZnJn3MTP3B9kE62NWDrjSuAPVXf9c4hu4grM");
    TukTukIntegration = class {
      ...
      async fundCronJob(cronJobPda, amount) {
        ...
        try {
          ...
          const tx = new import_web35.Transaction().add(
      ...
      async checkPendingTransfers(scheduledTransferPdas) {
        ...
        for (const pda of scheduledTransferPdas) {
          try {
            ...
            const recipient = new import_web35.PublicKey(recipientBytes);
      ...
      async executePendingTransfer(transferId, executeTransferIx) {
        try {
          const tx = new import_web35.Transaction().add(executeTransferIx);
          const signature = await (0, import_web35.sendAndConfirmTransaction)(this.connection, tx, [this.payer]);
          return { tx: signature };
        } catch (error) {
          throw new TukTukError(
...
__export(index_exports, {
  BATCH_PROOF_SEED: () => BATCH_PROOF_SEED2,
  DEPOSIT_HISTORY_SEED: () => DEPOSIT_HISTORY_SEED2,
  INTERVAL_SECONDS: () => INTERVAL_SECONDS,
  KAMINO_CUSDC_MINT: () => KAMINO_CUSDC_MINT,
  KAMINO_LENDING_PROGRAM_ID: () => KAMINO_LENDING_PROGRAM_ID2,
  KAMINO_MAIN_MARKET: () => KAMINO_MAIN_MARKET2,
  KAMINO_USDC_RESERVE: () => KAMINO_USDC_RESERVE,
  KEY_DERIVATION_MESSAGE: () => KEY_DERIVATION_MESSAGE,
  KaminoError: () => KaminoError,
  KaminoIntegration: () => KaminoIntegration,
  LocalStorageManager: () => LocalStorageManager,
  NOTE_COMMITMENT_REGISTRY_SEED: () => NOTE_COMMITMENT_REGISTRY_SEED2,
  NULLIFIER_SEED: () => NULLIFIER_SEED2,
  OperationType: () => OperationType,
  POOL_CTOKEN_ACCOUNT_SEED: () => POOL_CTOKEN_ACCOUNT_SEED,
  POOL_TOKEN_ACCOUNT_SEED: () => POOL_TOKEN_ACCOUNT_SEED,
  ...
  SCHEDULED_TRANSFER_SEED: () => SCHEDULED_TRANSFER_SEED2,
  SHIELD_POOL_SEED: () => SHIELD_POOL_SEED2,
  SublyVaultClient: () => SublyVaultClient,
  TRANSFER_HISTORY_SEED: () => TRANSFER_HISTORY_SEED2,
  TUKTUK_CRON_PROGRAM_ID: () => TUKTUK_CRON_PROGRAM_ID,
  TUKTUK_PROGRAM_ID: () => TUKTUK_PROGRAM_ID,
  ...
  USER_SHARE_SEED: () => USER_SHARE_SEED2,
  ...
  encryptTransferData: () => encryptTransferData,
  ...
  getIdl: () => getIdl,
  getNoteCommitmentRegistryPda: () => getNoteCommitmentRegistryPda,
...
var USDC_DECIMALS = 6;
var KAMINO_LENDING_PROGRAM_ID = new import_web3.PublicKey("KLend2g3cP87ber41VSz2cHu5M3mxzQS7pzLFz1UJwp");
var KAMINO_MAIN_MARKET = new import_web3.PublicKey("7u3HeHxYDLhnCoErrtycNokbQYbWGzLs6JSDqGAv5PfF");
var KAMINO_USDC_RESERVE = new import_web3.PublicKey("d4A2prbA2whSmMHHaHmRNKRpvqH8UgFfGzTqZGKfJxB");
var KAMINO_CUSDC_MINT = new import_web3.PublicKey("BNBUwNTkDEYgYfFg8sVB6S9gqTfzfj2uYPBYfRAJYr7u");
...
function getShieldPoolPda(programId = PROGRAM_ID) {
  return import_web32.PublicKey.findProgramAddressSync([SHIELD_POOL_SEED2], programId);
}
...
var TOKEN_2022_PROGRAM_ID = new import_web33.PublicKey("TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb");
var ASSOCIATED_TOKEN_PROGRAM_ID = new import_web33.PublicKey("ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL");
var NATIVE_MINT = new import_web33.PublicKey("So11111111111111111111111111111111111111112");
var NATIVE_MINT_2022 = new import_web33.PublicKey("9pan9bMn5HatX4EJdBwg9VgCa7Uz5HL8N1m5D3NdXejP");
...
var LocalStorageManager = class {
  ...
  encrypt(data) {
    ...
    const ciphertext = import_tweetnacl3.default.secretbox(dataBytes, nonce, this.encryptionKey);
    return {
  ...
  decrypt(encrypted) {
    ...
    const decrypted = import_tweetnacl3.default.secretbox.open(ciphertext, nonce, this.encryptionKey);
    if (!decrypted) {
...
async function encryptTransferData(recipient, encryptionKey, memo) {
  ...
  const nonce = import_tweetnacl3.default.randomBytes(24);
  const ciphertext = import_tweetnacl3.default.secretbox(paddedData, nonce, encryptionKey);
...
function decryptTransferData(encryptedData, encryptionKey) {
  ...
  const decrypted = import_tweetnacl3.default.secretbox.open(ciphertext, nonce, encryptionKey);
  if (!decrypted) {
...
var USDC_MINT = new import_web34.PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var PRIVACY_CASH_PROGRAM_ID = new import_web34.PublicKey("9fhQBbumKEFuXtMBDw8AaQyAjCorLGJQiS3skWZdQyQD");
var PrivacyCashIntegration = class {
  ...
  async initialize() {
    ...
    try {
      ...
      let ownerKey;
      if (this.config.privateKey instanceof import_web34.Keypair) {
...
var KAMINO_LENDING_PROGRAM_ID2 = new import_web36.PublicKey("KLend2g3cP87ber41VSz2cHu5M3mxzQS7pzLFz1UJwp");
var USDC_MINT2 = new import_web36.PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
var KAMINO_MAIN_MARKET2 = new import_web36.PublicKey("7u3HeHxYDLhnCoErrtycNokbQYbWGzLs6JSDqGAv5PfF");
var KaminoIntegration = class {
  ...
  async depositToKamino(amount) {
    ...
    try {
      ...
      const signature = await (0, import_web36.sendAndConfirmTransaction)(this.connection, tx, [this.payer]);
...
var SublyVaultClient = class {
  ...
  async initialize(idl, options) {
    ...
    if (options.enableTukTuk) {
      ...
      this.tuktuk = createTukTukIntegration({
        ...
        payer: import_web37.Keypair.generate(),
  ...
  async getKaminoReserveLiquiditySupply() {
    ...
    return new import_web37.PublicKey("BDdS2G7cZPVxJNkHqTEMHk8WkFvhGNm3X1sNzTMPaLbk");
  }
  /**
